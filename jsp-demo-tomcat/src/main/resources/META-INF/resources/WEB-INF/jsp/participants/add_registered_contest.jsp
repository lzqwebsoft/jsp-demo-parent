  ...
  ================================================== -->
    <div class="two_third lastcolumn contact1">
        <div id="contactForm">
            ...
            <form action="add_registered_contest" method="POST" id="contact_form">
                <div class="name">
                    <label for="contest_list">Choose Contest:</label>
                    <form:select path="contest_list" id="contest_list" name="contest_type_id">
                        <form:option  value="" label="Select Contest"></form:option>
                        <form:options items="${contest_list}" itemLabel="title" itemValue="contest_id"></form:options>
                    </form:select>
                </div>
                <div class="name">
