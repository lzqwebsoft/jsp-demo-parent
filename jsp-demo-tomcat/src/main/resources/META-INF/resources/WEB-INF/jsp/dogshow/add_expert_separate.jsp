...
<div id="header">
    <div class="container">
        <!-- Header | Logo, Menu
            ================================================== -->
        <div class="logo"><a href="${pageContext.request.contextPath}/home_page" a><img src="${pageContext.request.contextPath}/images/logo.png" alt="" style="height: 120px; margin-bottom: 10px"/></a></div>
        <div class="mainmenu">
            <div id="mainmenu">
                <ul class="sf-menu">
  ...
  ================================================== -->
    <div class="two_third lastcolumn contact1">
        <div id="contactForm">
            ...
            <form action="${pageContext.request.contextPath}/add_expert" method="POST" id="contact_form">
                <div class="name">
