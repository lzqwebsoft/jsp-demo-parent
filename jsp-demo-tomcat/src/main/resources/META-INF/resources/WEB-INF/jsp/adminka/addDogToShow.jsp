                    ...
                    <div class="col-md-auto">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form method="POST" action="/admin/addDogToShow">
                                    <div class="row">
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Введите Страну хозяина<span style="color: red;">*</span>:</label>
                                                <input type="text" class="form-control" name="olocation" id="olocation">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
