                            ...
                            <div class="card-content">
                                <form method="POST" action="/admin/addTest">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group label" id="datepicker-row">
                                                <label class="control-label">Дата</label>
                                                <input type="date" class="form-control" name="date" id="date" min=<fmt:formatDate value="${date}" pattern="yyyy-MM-dd" />>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Спонсоры</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group label-floating">
                                                <label class="label">Выберите конкурсы, которые будут на выставке</label>
                                                <div class="checkbox">
                                                    <form:checkboxes items="${contests}" element="label"
                                                                     path="checked" />
                                                        <%--<c:forEach var="contest" items="${contests}">--%>
                                                        <%--<label>--%>
                                                            <%--<input type="checkbox" name="${contest}" checked="checked">--%>
                                                            <%--${contest}--%>
                                                        <%--</label>--%>
                                                        <%--<br>--%>
                                                    <%--</c:forEach>--%>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Добавить афишу к выставке</label>
