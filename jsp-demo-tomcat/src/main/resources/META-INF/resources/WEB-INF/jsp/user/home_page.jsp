    ...
    <div class="cd-user-modal-container"> <!-- основной контейнер -->
        ...
        <div > <!-- форма регистрации -->
            <form class="cd-form" method="POST" action="/registration">
                <p class="fieldset">
                    <label class="image-replace" for="fname">First Name</label>
                ...
                <p class="fieldset">
                    <label class="image-replace" for="sname">Second Name</label>
                    <input class="full-width has-padding has-border" id="sname" name="sname" type="text" placeholder="Second name">
                    <span class="cd-error-message">There is an error!</span>
                </p>
                <p class="fieldset">
                    <label class="image-replace" for="lname">Last Name</label>
                ...
                <p class="fieldset">
                    ...
                    <input id="signup-password" name="signup-password" type="text"  placeholder="Password">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/for_registration/main.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/for_registration/modernizr.js"></script>
</body>
</html>
