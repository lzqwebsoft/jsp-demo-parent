            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <div id="Add" class="collapse">
                        <ul><a href="${pageContext.request.contextPath}/admin/addDogShow">Выставку</a></ul>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                <p class="category">Number of Your Dog Shows</p>
                                <h3 class="title">SOME number<br><small>Dog Shows</small></h3>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">note_add</i> <a href="${pageContext.request.contextPath}/createDogShow">Create new Dog Show</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header" data-background-color="purple">
                                <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                        <span class="nav-tabs-title">Your:</span>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="profile">
                                        <table class="table">
                                            <tbody>
                                            <tr>
                                                <td>Dog Show's Title</td>
                                                <td class="td-actions text-right">
                                                    <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-simple btn-xs">
                                                        <i class="material-icons"><a href="/admin/changeShow">edit</a></i>
                                                    </button>
                                                    <button type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-simple btn-xs">
                                                        <i class="material-icons" href="/admin/deleteShow">close</i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
